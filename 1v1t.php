...
<br><br>
<form action=scripts/mydrop_1v1t.php class="pure-form pure-form-aligned">
  Belichtung starten
  <br><br>
  ...
  Blitzen
  <br><br>
  <label>Warten (ms) <input name="w3" type="number" value="<?php echo $content[3]; ?>"></label>
  <br><br>
  Belichtung stoppen
  <br><br><br>
